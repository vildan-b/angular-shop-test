...
export class ProductComponent implements OnInit {
  ...
  products : Product[] = [
    ...
    {id:4, name: "", price: 5500, categoryId:2, description : "Asus Zenbok added 2 packages, removed 1 package, and audited 907 packages in 13s", imageUrl: "https://images.unsplash.com/photo-1554415707-6e8cfc93fe23?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"},
